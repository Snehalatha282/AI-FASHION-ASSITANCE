...
def open_image(img_data):
    if isinstance(img_data,str):
        ...
        img = PIL.Image.open(io.ByteIO(response.content))
...
st.title("Enter your styling query and get image-based recommendations, or upload an image to retrive similar images.")

uploaded_file = st.file_uploader("upload an image to retrieve similar images:", type=["jpg","jpg","png"])
query = st.text_input("Or, enter your styling query:")

if st.button("Generate Styling Ideas / Retrive Images"):
    ...
    if uploaded_file is not None:
        ...
        for i,img_data in enumerate(retrieved_imgs['data'][0]):
            try:
                ...
                prompt = ("You are a professional fashion and styling assistant with expertise in creating personalized outfit recommandation"
            ...
            try:
                ...
                st.subheader("Styling Recommedations:")
